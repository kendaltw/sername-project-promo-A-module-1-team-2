# Projet-promo-A-module-1-team-2
...
- VER:
  ...
  - Crear **backlog** (tablero de tareas) en GitHub: projects - new project - elegir diseño (team planing es el más sencillo) - poner nombre - create projet - settings (*cambiar a visibilidad pública*) - save changes - *en el menú izquierdo* Manage access (*invitar colaboradoras*) - *Volver al proyecto, en el backlog* add item (*empezar a crear tareas*).